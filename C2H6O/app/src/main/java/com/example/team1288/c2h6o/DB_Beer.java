...
//        insert("레벤브로이", 33, 3300, "그만하자...");
        ...
        insert(R.drawable.beer_cass ,"Cass", 4.5, 2400, "이것은 카스이다...");
        insert(R.drawable.beer_hite, "Hite", 4.5, 2400, "나는 하이트가 실다....");
        insert(R.drawable.beer_max, "Max", 4.5, 2400, "맥스 왜먹냐 ㄹㅇ");
        insert(R.drawable.beer_heineken, "Heineken", 5, 3900, "하이네켄...병이..예쁘다...");
//        insert("Sapporo", 19, 1900, "삿포로 별 존예임 ㄹㅇ");
        insert(R.drawable.beer_hoegaarden, "Hoegaarden", 20, 2000, "국내 최초로 소개된 화이트 맥주. \n오렌지 껍질이 들어가 향긋하다.");
...
//        insert("Tsingtao", 25, 2500, "양꼬치엔 칭따오!");
        insert(R.drawable.beer_kozel, "Kozel Dark", 26, 2600, "쌉싸래한 동시에 달콤한 맛이 특징인 흑맥주. \n최고의 맥주로 여덟 차례 선정되었다.");
